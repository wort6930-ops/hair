...
# Credentials are mapped to the same variable names used across uploaders
# so sub-module code only needs to change the import path, not variable names.
AWS_ACCESS_KEY_ID = os.getenv('CF_R2_ACCESS_KEY_ID', '')
AWS_SECRET_ACCESS_KEY = os.getenv('CF_R2_SECRET_ACCESS_KEY', '')
AWS_S3_BUCKET = os.getenv('CF_R2_BUCKET_NAME', '')
AWS_REGION = 'us-east-1'  # dummy value — Cloudflare R2 ignores region
